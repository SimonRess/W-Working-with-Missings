...
```{r planing-dataset-creation, out.width = "100%", message=FALSE, out.height="100%"}
#Link: https://mermaid-js.github.io/mermaid/#/flowchart  # , fig.width = 5, fig.asp = .2
#Libraries:
...
## Data Set Creation
```{r dataset-creation, echo=TRUE, size="tiny"}
#Create variables
set.seed(415)
